# Integrating RebaseAbsorb

## From Solidity

```solidity
import {RebaseAbsorbHook} from "rebase-absorb/src/hooks/RebaseAbsorbHook.sol";
...
const hook = getHook("rebase-absorb");
const address = hookAddress("rebase-absorb", 8453);              // Base
...
```solidity
IHookMetadata(hookAddress).hookName();   // "RebaseAbsorb"
...
More at https://rebase-absorb.pages.dev.
